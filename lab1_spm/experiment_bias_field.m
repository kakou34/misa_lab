...
vol = niftiread(fullfile(base_data_path, num2str(1), '/T2_FLAIR.nii'));
...
for i = 1:4
    ...
    msg = strcat("\nSample 1, T2_FLAIR => reg: ", num2str(bias_reg(i)), " fwhm: ", num2str(bias_fwhm), " dice CSF: ", num2str(dice_res(1)), " dice GM: ", num2str(dice_res(2)), " dice WM: ", num2str(dice_res(3)));
    disp(msg);
    fprintf(fid, msg);
    ...
    fig_fn = strcat("figs/bias_exp/s1_t2_", num2str(bias_reg(i)), "_",num2str(bias_fwhm),".png");
...
for i = 1:4
    ...
    % Dice 
    dice_res = dice(res_seg, labels);
    msg = strcat("\nSample 1, T2 FLAIR => reg: ", num2str(bias_reg), " fwhm: ", num2str(bias_fwhm(i)), " dice CSF: ", num2str(dice_res(1)), " dice GM: ", num2str(dice_res(2)), " dice WM: ", num2str(dice_res(3)));
    disp(msg);
    fprintf(fid, msg);
    ...
    fig_fn = strcat("figs/bias_exp/s1_t2_", num2str(bias_reg), "_",num2str(bias_fwhm(i)),".png");
    exportgraphics(t,fig_fn)
end
